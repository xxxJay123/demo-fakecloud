...
import com.example.demofakecloud.service.FilesStorageService;
...
public class UserFileController {
    ...
    public ResponseEntity<String> uploadFile(
        ...
        log.info("user in controller: {}" + userDetails.toString());
        try {
            String fileName = storageService.save(file, userDetails);
